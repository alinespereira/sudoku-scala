      ...
      new BorderPanel {
        ...
        layout(new Button(Action("Show It!") {
          ...
          mutex.selected.get match {
            ...
            case `ynp` =>
              val options =
                List("Yes, please", "No, thanks", "No eggs, no ham!")
              label.text = showOptions(
                buttons,
        ...
        layout(new Button(Action("Show It!") {
          ...
          mutex.selected.get match {
            ...
            case `custom2` =>
              ...
              d2.open()
              d1.contents = Button(
                "Close Me! I am the owner and will automatically close the other one"
              ) {
                d1.close()
              }
